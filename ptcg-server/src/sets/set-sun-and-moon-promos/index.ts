...
export const setSunAndMoonPromos: Card[] = [
  ...
  new Lucario2SMP(),
  new Mimikyu2SMP(),
  new DawnWingsNecrozmaGXSMP(),
  new DuskManeNecrozmaGXSMP(),
  new MalamarSMP(),
  new NaganadelGXSMP(),
  new UltraNecrozmaGXSMP(),
  new DelcattySMP(),
  new GlaceonGXSMP(),
  new RaikouSMP(),
  new GiratinaSMP(),
  ...
  new PersianSMP(),
  new MewtwoMewGXSMP(),
  new GarchompGiratinaGXSMP(),
  new NecrozmaSMP(),
  new MoltresZapdosArticunoGXSMP(),
  new Mewtwo2SMP(),
  new BuzzwoleSMP(),
  new EnteiSMP(),
  new PhioneSMP(),
  new BlacephalonSMP(),
  new Charizard2SMP(),
  new CharizardBraixenGXSMP(),
  new ReshiramCharizardGX2SMP(),
