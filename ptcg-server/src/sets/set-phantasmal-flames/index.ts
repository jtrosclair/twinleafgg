...
import { JumboIce } from './jumbo-ice';
...
export const setPhantasmalFlames: Card[] = [
  ...
  new Oricorioex2PFL(),
  new Rotomex2PFL(),
  new MegaSharpedoex2PFL(),
  new MegaLopunnyex2PFL(),
  new BattleColosseum2PFL(),
  new Dawn2PFL(),
  new Firebreather2PFL(),
  new GrimsleysGambit2PFL(),
  new SacredCharm2PFL(),
  new SwitchPFL(),
  new IgnitionEnergyPFL(),
  new MegaCharizardXex3PFL(),
  new Rotomex3PFL(),
