import { CardList, CardTag, ChooseCardsPrompt, GameError, GameMessage, ShowCardsPrompt, State, StateUtils, StoreLike, SuperType, TrainerCard, TrainerType } from '../../game';
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    if (effect instanceof TrainerEffect && effect.trainerCard === this) {
      ...
      store.prompt(state, new ChooseCardsPrompt(
        ...
        allPrizeCards,
        { superType: SuperType.POKEMON, tags: [CardTag.ULTRA_BEAST] },
