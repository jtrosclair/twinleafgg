...
export enum GameLog {
  ...
  LOG_PLAYER_TRANSFORMS_INTO_POKEMON = 'LOG_PLAYER_TRANSFORMS_INTO_POKEMON', // { name, card, pokemon }
  ...
  LOG_PLAYER_CONCEDED = 'LOG_PLAYER_CONCEDED', // { name }
  ...
  LOG_PLAYER_DISCARDS_WITH_FIELD_BLOWER = 'LOG_PLAYER_DISCARDS_WITH_FIELD_BLOWER', // { name, card, effectName }
