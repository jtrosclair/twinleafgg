...
export declare class PutDamageEffect extends AbstractAttackEffect implements Effect {
    ...
    surviveOnTenHPReason: undefined | string;
    weaknessApplied: boolean;
    private nonstackingDamageReducers;
    constructor(base: AttackEffect, damage: number);
    reduceDamage(amount: number, source?: string | undefined): void;
}
export declare class AfterWeaknessAndResistanceEffect extends AbstractAttackEffect implements Effect {
    readonly type: string;
    preventDefault: boolean;
    damage: number;
    constructor(base: AttackEffect, damage: number);
