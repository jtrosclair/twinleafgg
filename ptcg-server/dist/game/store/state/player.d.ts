...
export declare class Player {
    ...
    readonly ATTACK_EFFECT_SUPPORTER_LOCK = "ATTACK_EFFECT_SUPPORTER_LOCK";
    readonly ATTACK_EFFECT_ITEM_LOCK = "ATTACK_EFFECT_ITEM_LOCK";
    readonly ATTACK_EFFECT_TOOL_LOCK = "ATTACK_EFFECT_TOOL_LOCK";
    readonly ATTACK_EFFECT_STADIUM_LOCK = "ATTACK_EFFECT_STADIUM_LOCK";
    readonly ATTACK_EFFECT_SPECIAL_ENERGY_LOCK = "ATTACK_EFFECT_SPECIAL_ENERGY_LOCK";
    ...
    switchPokemon(target: PokemonCardList, store?: any, state?: any): void;
}
