export declare enum CardTag {
    ...
    POKEMON_VMAX = "VMAX",
    POKEMON_VSTAR = "VSTAR",
    POKEMON_VUNION = "V-UNION",
    ACE_SPEC = "Ace Spec",
    RADIANT = "Radiant",
    ROCKETS_SECRET_MACHINE = "Secret Machine",
    ...
    TAG_TEAM = "Tag Team",
    TEAM_AQUA = "Team Aqua's",
    TEAM_MAGMA = "Team Magma's",
    ...
    ARVENS = "Arven's",
    AURAS = "Aura's",
    POKEMON_SV_MEGA = "Mega ex",
    HOLONS = "Holon's",
    ROCKETS = "Rocket's",
    TEAM_ROCKET = "Team Rocket's",
    UNOWN = "Unown",
    PRIMAL = "Primal",
    ARCEUS = "Arceus",
    VS = "VS"
...
export declare enum Archetype {
    ...
    TROPIUS = "Tropius",
    CHIMECHO = "Chimecho",
    MEGA_CHIMECHO = "Mega Chimecho",
    ABSOL = "Absol",
    MEGA_ABSOL = "Mega Absol",
    MEGA_ABSOL_Z = "Mega Absol Z",
    SNORUNT = "Snorunt",
    GLALIE = "Glalie",
    ...
    GABITE = "Gabite",
    GARCHOMP = "Garchomp",
    MEGA_GARCHOMP = "Mega Garchomp",
    GARCHOMP_MEGA_Z = "Mega Garchomp Z",
    MUNCHLAX = "Munchlax",
    RIOLU = "Riolu",
    LUCARIO = "Lucario",
    MEGA_LUCARIO = "Mega Lucario",
    LUCARIO_MEGA_Z = "Mega Lucario Z",
    ...
    MEGA_EELEKTROSS = "Mega Eelektross",
    ELGYEM = "Elgyem",
    BEHEEYEM = "Beheeyem",
    LITWICK = "Litwick",
    LAMPENT = "Lampent",
    CHANDELURE = "Chandelure",
    MEGA_CHANDELURE = "Mega Chandelure",
    AXEW = "Axew",
    FRAXURE = "Fraxure",
    HAXORUS = "Haxorus",
    CUBCHOO = "Cubchoo",
    ...
    MEGA_CHESNAUGHT = "Mega Chesnaught",
    FENNEKIN = "Fennekin",
    BRAIXEN = "Braixen",
    DELPHOX = "Delphox",
    MEGA_DELPHOX = "Mega Delphox",
    FROAKIE = "Froakie",
    FROGADIER = "Frogadier",
    GRENINJA = "Greninja",
    MEGA_GRENINJA = "Mega Greninja",
    BUNNELBY = "Bunnelby",
    DIGGERSBY = "Diggersby",
    ...
    LITLEO = "Litleo",
    PYROAR = "Pyroar",
    MEGA_PYROAR = "Mega Pyroar",
    FLABEBE = "Flab\u00E9b\u00E9",
    FLOETTE = "Floette",
    MEGA_FLOETTE = "Mega Floette",
    FLORGES = "Florges",
    SKIDDO = "Skiddo",
    GOGOAT = "Gogoat",
    PANCHAM = "Pancham",
    ...
    INKAY = "Inkay",
    MALAMAR = "Malamar",
    MEGA_MALAMAR = "Mega Malamar",
    BINACLE = "Binacle",
    BARBARACLE = "Barbaracle",
    MEGA_BARBARACLE = "Mega Barbaracle",
    SKRELP = "Skrelp",
    DRAGALGE = "Dragalge",
    MEGA_DRAGALGE = "Mega Dragalge",
    CLAUNCHER = "Clauncher",
    CLAWITZER = "Clawitzer",
    ...
    MEGA_CRABOMINABLE = "Mega Crabominable",
    ORICORIO = "Oricorio",
    CUTIEFLY = "Cutiefly",
    RIBOMBEE = "Ribombee",
    ROCKRUFF = "Rockruff",
    ...
    MEGA_SCOVILLAIN = "Mega Scovillain",
    RELLOR = "Rellor",
    RABSCA = "Rabsca",
    FLITTLE = "Flittle",
    ESPATHRA = "Espathra",
    ...
    MEGA_BAXCALIBUR = "Mega Baxcalibur",
...
export declare function isCoreFormat(format: Format): boolean;
