...
export declare enum GameCardMessage {
    ...
    CHOOSE_DEVOLVE_COUNT = "CHOOSE_DEVOLVE_COUNT",
...
export declare enum GameLog {
    ...
    LOG_PLAYER_REFLIPS_WITH_GLIMWOOD_TANGLE = "LOG_PLAYER_REFLIPS_WITH_GLIMWOOD_TANGLE",
...
export declare const GameMessage: {
    ...
    CHOOSE_DEVOLVE_COUNT: GameCardMessage.CHOOSE_DEVOLVE_COUNT;
