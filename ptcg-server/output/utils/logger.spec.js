...
describe('Logger', () => {
    ...
    describe('Basic Logging', () => {
        ...
        it('should apply default values for missing fields', () => {
            ...
            expect(recentLogs[0].level).toBe(logger_1.LogLevel.INFO);
    ...
    describe('State Preservation Logging', () => {
        ...
        it('should log state restoration events', () => {
            ...
            const errorLogs = logger.getRecentLogs('state-restoration', logger_1.LogLevel.ERROR);
    ...
    describe('Metrics and Filtering', () => {
        ...
        it('should filter logs by level', () => {
            ...
            const errorLogs = logger.getRecentLogs(undefined, logger_1.LogLevel.ERROR);
