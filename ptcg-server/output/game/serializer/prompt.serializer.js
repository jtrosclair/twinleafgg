...
const show_mulligan_prompt_1 = require("../store/prompts/show-mulligan-prompt");
const wait_prompt_1 = require("../store/prompts/wait-prompt");
class PromptSerializer {
    constructor() {
        this.rows = [
            ...
            { classValue: show_mulligan_prompt_1.ShowMulliganPrompt, type: 'ShowMulliganPrompt' },
            { classValue: wait_prompt_1.WaitPrompt, type: 'WaitPrompt' },
        ];
