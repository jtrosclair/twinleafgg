...
class GameStatsTracker {
     ...
     */
    static trackPrizeTaken(player, prizeCount) {
        if (prizeCount <= 0) {
            return;
        }
     ...
     */
    static trackDamageDealt(attackingPlayer, attackingPokemon, damage) {
        if (damage <= 0) {
            return;
        }
     ...
     */
    static generatePokemonId(pokemonCardList) {
        ...
        const cardListId = pokemonCardList.__uniqueId || this.assignUniqueIdToCardList(pokemonCardList);
     ...
     */
    static assignUniqueIdToCardList(pokemonCardList) {
     ...
     */
    static updateTopPokemon(player, pokemonStats) {
