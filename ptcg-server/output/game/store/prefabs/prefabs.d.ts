...
export declare function CLEAN_UP_SUPPORTER(effect: TrainerEffect, player: Player): void;
/**
 ...
 */
export declare function CAN_PLAY_SUPPORTER_CARD(store: StoreLike, state: State, player: Player, trainerCard: TrainerCard): boolean;
/**
