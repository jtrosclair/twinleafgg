...
describe('Core Reconnection Integration', () => {
    ...
    beforeEach(() => {
        ...
        core = new core_1.Core(reconnectionConfig);
        // Setup mock user
        mockUser = {
            id: 1,
            name: 'TestUser',
    ...
    describe('Core initialization', () => {
        ...
        it('should initialize with default config when none provided', () => {
            const coreWithDefaults = new core_1.Core();
    ...
    describe('disconnect method', () => {
        ...
        it('should handle disconnection of client with active game', async () => {
            await core.connect(mockClient);
            const game = core.createGame(mockClient, ['card1', 'card2'], new game_settings_1.GameSettings());
    ...
    describe('notification system', () => {
        it('should support player disconnection notifications', async () => {
            ...
            const client2 = Object.assign(Object.assign({}, mockClient), { id: 2, name: 'TestUser2', user: { id: 2, name: 'TestUser2' }, games: [], onPlayerDisconnected: jasmine.createSpy('onPlayerDisconnected') });
            await core.connect(mockClient);
        ...
        it('should support player reconnection notifications', async () => {
            const client2 = Object.assign(Object.assign({}, mockClient), { id: 2, name: 'TestUser2', user: { id: 2, name: 'TestUser2' }, games: [], onPlayerReconnected: jasmine.createSpy('onPlayerReconnected') });
            await core.connect(client2);
    ...
    describe('edge cases', () => {
        it('should handle multiple clients', async () => {
            const client2 = Object.assign(Object.assign({}, mockClient), { id: 2, name: 'TestUser2', user: { id: 2, name: 'TestUser2' }, games: [] });
            await core.connect(mockClient);
            await core.connect(client2);
            expect(core.clients).toContain(mockClient);
        ...
        it('should handle game state changes', async () => {
            ...
            expect(game.state.phase).toBe(state_1.GamePhase.FINISHED);
        });
