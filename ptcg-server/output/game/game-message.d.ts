export declare enum GameCoreError {
    ...
    ERROR_BOT_FORMAT_NOT_ALLOWED = "ERROR_BOT_FORMAT_NOT_ALLOWED",
...
export declare enum GameStoreMessage {
    ...
    CHOOSE_PRIZE_CARD_TO_DISCARD = "CHOOSE_PRIZE_CARD_TO_DISCARD",
    ...
    NO_CARDS_IN_DECK = "NO_CARDS_IN_DECK",
    NO_CARDS_IN_DISCARD = "NO_CARDS_IN_DISCARD",
    ...
    SETUP_CARDS_AVAILABLE = "SETUP_CARDS_AVAILABLE",
    USE_SETUP_CARDS = "USE_SETUP_CARDS",
    MULLIGAN = "MULLIGAN",
    CHOOSE_PRIZES_SETUP = "CHOOSE_PRIZES_SETUP",
...
export declare enum GameCardMessage {
    ...
    CHOOSE_CARDS_TO_PUT_ON_BOTTOM_OF_THE_DECK = "CHOOSE_CARDS_TO_PUT_ON_BOTTOM_OF_THE_DECK",
    ...
    CHOOSE_POKEMON_WITH_DAMAGE = "CHOOSE_POKEMON_WITH_DAMAGE",
    CHOOSE_POKEMON_TO_MOVE_DAMAGE_TO = "CHOOSE_POKEMON_TO_MOVE_DAMAGE_TO",
    ...
    CHOOSE_POKEMON_TO_SWAP = "CHOOSE_POKEMON_TO_SWAP",
    CHOOSE_POKEMON_TO_SHUFFLE = "CHOOSE_POKEMON_TO_SHUFFLE",
    CHOOSE_ENERGY_TO_DISCARD = "CHOOSE_ENERGY_TO_DISCARD",
    CHOOSE_ENERGY_TO_PAY_RETREAT_COST = "CHOOSE_ENERGY_TO_PAY_RETREAT_COST",
    ...
    NO_BENCH_SLOTS_AVAILABLE = "NO_BENCH_SLOTS_AVAILABLE",
    ...
    WANT_TO_DRAW_CARDS = "WANT_TO_DRAW_CARDS",
    WANT_TO_DEAL_MORE_DAMAGE = "WANT_TO_DEAL_MORE_DAMAGE",
    ...
    WANT_TO_PLAY_ALL_CARDS_AT_ONCE = "WANT_TO_PLAY_ALL_CARDS_AT_ONCE",
    WANT_TO_SHUFFLE_POKEMON_INTO_DECK = "WANT_TO_SHUFFLE_POKEMON_INTO_DECK",
    SHUFFLE_POKEMON_INTO_DECK = "SHUFFLE_POKEMON_INTO_DECK",
    WANT_TO_SWITCH_POKEMON = "WANT_TO_SWITCH_POKEMON",
    WANT_TO_USE_EFFECT_OF_ATTACK = "WANT_TO_USE_EFFECT_OF_ATTACK",
    WANT_TO_USE_ABILITY = "WANT_TO_USE_ABILITY",
    WANT_TO_SHUFFLE_OPPONENTS_CARDS = "WANT_TO_SHUFFLE_OPPONENTS_CARDS",
    WANT_TO_USE_ABILITY_FROM_PRIZES = "WANT_TO_USE_ABILITY_FROM_PRIZES",
    WANT_TO_USE_ITEM_FROM_PRIZES = "WANT_TO_USE_ITEM_FROM_PRIZES",
    ...
    RETURN_TO_TOP_OF_DECK = "RETURN_TO_TOP_OF_DECK",
    ...
    CHOOSE_CARD_TO_PUT_ON_BOTTOM = "CHOOSE_CARD_TO_PUT_ON_BOTTOM",
    FORMAT_ALL = "FORMAT_ALL",
    FORMAT_STANDARD = "FORMAT_STANDARD",
    FORMAT_STANDARD_NIGHTLY = "FORMAT_STANDARD_NIGHTLY",
    FORMAT_EXPANDED = "FORMAT_EXPANDED",
    FORMAT_UNLIMITED = "FORMAT_UNLIMITED",
    FORMAT_ETERNAL = "FORMAT_ETERNAL",
    FORMAT_RETRO = "FORMAT_RETRO",
    FORMAT_GLC = "FORMAT_GLC",
...
export declare enum GameLog {
    ...
    LOG_ABILITY_BLOCKS_DAMAGE = "LOG_ABILITY_BLOCKS_DAMAGE",
    LOG_SURVIVES_ON_TEN_HP = "LOG_SURVIVES_ON_TEN_HP",
    ...
    LOG_PLAYER_DISABLES_ITEMS_UNTIL_END_OF_NEXT_TURN = "LOG_PLAYER_DISABLES_ITEMS_UNTIL_END_OF_NEXT_TURN",
    LOG_PLAYER_DISABLES_SUPPORTERS_UNTIL_END_OF_NEXT_TURN = "LOG_PLAYER_DISABLES_SUPPORTERS_UNTIL_END_OF_NEXT_TURN",
    ...
    LOG_PLAYER_TRANSFORMS_INTO_POKEMON = "LOG_PLAYER_TRANSFORMS_INTO_POKEMON",
    ...
    LOG_PLAYER_CONCEDED = "LOG_PLAYER_CONCEDED",
    LOG_PLAYER_HEALS_POKEMON = "LOG_PLAYER_HEALS_POKEMON",
    ...
    LOG_PLAYER_DEALS_DAMAGE = "LOG_PLAYER_DEALS_DAMAGE",
    LOG_PLAYER_PLACES_DAMAGE_COUNTERS = "LOG_PLAYER_PLACES_DAMAGE_COUNTERS",
    ...
    LOG_PLAYER_RETURNS_CARD_TO_HAND = "LOG_PLAYER_RETURNS_CARD_TO_HAND",
    ...
    LOG_TURN = "LOG_TURN",
    LOG_PLAYER_GUSTS_POKEMON_TO_ACTIVE = "LOG_PLAYER_GUSTS_POKEMON_TO_ACTIVE",
    LOG_PLAYER_DISCARDS_WITH_FIELD_BLOWER = "LOG_PLAYER_DISCARDS_WITH_FIELD_BLOWER",
    LOG_PLAYER_SWITCHES_POKEMON_TO_ACTIVE = "LOG_PLAYER_SWITCHES_POKEMON_TO_ACTIVE",
    LOG_PLAYER_DISCARDS_CARD = "LOG_PLAYER_DISCARDS_CARD",
    LOG_PLAYER_DISCARDS_CARD_FROM_HAND = "LOG_PLAYER_DISCARDS_CARD_FROM_HAND",
    LOG_DISCARD_STADIUM_CHAOTIC_SWELL = "LOG_DISCARD_STADIUM_CHAOTIC_SWELL",
    LOG_PLAYER_PUTS_CARD_IN_LOST_ZONE = "LOG_PLAYER_PUTS_CARD_IN_LOST_ZONE",
    LOG_PLAYER_PUTS_CARD_IN_HAND = "LOG_PLAYER_PUTS_CARD_IN_HAND",
    LOG_PLAYER_PUTS_CARD_ON_BOTTOM_OF_DECK = "LOG_PLAYER_PUTS_CARD_ON_BOTTOM_OF_DECK",
    LOG_HISUIAN_HEAVY_BALL = "LOG_HISUIAN_HEAVY_BALL",
    LOG_SUDDEN_DEATH = "LOG_SUDDEN_DEATH",
    LOG_PLAYER_CHOOSES = "LOG_PLAYER_CHOOSES",
    LOG_CARD_MOVED = "LOG_CARD_MOVED",
    LOG_SHUFFLE_POKEMON_INTO_DECK = "SHUFFLE_POKEMON_INTO_DECK"
}
export declare const GameMessage: {
    ...
    UP: GameCardMessage.UP;
    DOWN: GameCardMessage.DOWN;
    ITEMS: GameCardMessage.ITEMS;
    SUPPORTERS: GameCardMessage.SUPPORTERS;
    ...
    ATTACH_ENERGY_TO_BENCH: GameCardMessage.ATTACH_ENERGY_TO_BENCH;
    ...
    CHOOSE_CARDS_TO_RETURN_TO_PRIZES: GameCardMessage.CHOOSE_CARDS_TO_RETURN_TO_PRIZES;
    ...
    CHOOSE_CARD_FROM_DISCARD: GameCardMessage.CHOOSE_CARD_FROM_DISCARD;
    CHOOSE_CARD_FROM_DECK: GameCardMessage.CHOOSE_CARD_FROM_DECK;
    CHOOSE_CARDS_TO_PUT_ON_TOP_OF_THE_DECK: GameCardMessage.CHOOSE_CARDS_TO_PUT_ON_TOP_OF_THE_DECK;
    CHOOSE_CARDS_TO_PUT_ON_BOTTOM_OF_THE_DECK: GameCardMessage.CHOOSE_CARDS_TO_PUT_ON_BOTTOM_OF_THE_DECK;
    CHOOSE_ONE_ITEM_AND_ONE_TOOL_TO_HAND: GameCardMessage.CHOOSE_ONE_ITEM_AND_ONE_TOOL_TO_HAND;
    CHOOSE_ONE_DARK_POKEMON_AND_ONE_ENERGY_TO_HAND: GameCardMessage.CHOOSE_ONE_DARK_POKEMON_AND_ONE_ENERGY_TO_HAND;
    CHOOSE_ONE_ITEM_AND_ONE_LIGHTNING_ENERGY_TO_HAND: GameCardMessage.CHOOSE_ONE_ITEM_AND_ONE_LIGHTNING_ENERGY_TO_HAND;
    CHOOSE_ONE_POKEMON_AND_ONE_SUPPORTER_TO_HAND: GameCardMessage.CHOOSE_ONE_POKEMON_AND_ONE_SUPPORTER_TO_HAND;
    ...
    CHOOSE_POKEMON_WITH_DAMAGE: GameCardMessage.CHOOSE_POKEMON_WITH_DAMAGE;
    CHOOSE_POKEMON_TO_MOVE_DAMAGE_TO: GameCardMessage.CHOOSE_POKEMON_TO_MOVE_DAMAGE_TO;
    ...
    CHOOSE_POKEMON_TO_SWAP: GameCardMessage.CHOOSE_POKEMON_TO_SWAP;
    CHOOSE_POKEMON_TO_SHUFFLE: GameCardMessage.CHOOSE_POKEMON_TO_SHUFFLE;
    CHOOSE_ENERGY_TO_DISCARD: GameCardMessage.CHOOSE_ENERGY_TO_DISCARD;
    CHOOSE_ENERGY_TO_PAY_RETREAT_COST: GameCardMessage.CHOOSE_ENERGY_TO_PAY_RETREAT_COST;
    ...
    NO_BENCH_SLOTS_AVAILABLE: GameCardMessage.NO_BENCH_SLOTS_AVAILABLE;
    ...
    WANT_TO_DEAL_MORE_DAMAGE: GameCardMessage.WANT_TO_DEAL_MORE_DAMAGE;
    WANT_TO_HEAL_POKEMON: GameCardMessage.WANT_TO_HEAL_POKEMON;
    ...
    WANT_TO_PLAY_ALL_CARDS_AT_ONCE: GameCardMessage.WANT_TO_PLAY_ALL_CARDS_AT_ONCE;
    WANT_TO_SHUFFLE_POKEMON_INTO_DECK: GameCardMessage.WANT_TO_SHUFFLE_POKEMON_INTO_DECK;
    SHUFFLE_POKEMON_INTO_DECK: GameCardMessage.SHUFFLE_POKEMON_INTO_DECK;
    WANT_TO_SWITCH_POKEMON: GameCardMessage.WANT_TO_SWITCH_POKEMON;
    WANT_TO_USE_EFFECT_OF_ATTACK: GameCardMessage.WANT_TO_USE_EFFECT_OF_ATTACK;
    WANT_TO_USE_ABILITY: GameCardMessage.WANT_TO_USE_ABILITY;
    WANT_TO_SHUFFLE_OPPONENTS_CARDS: GameCardMessage.WANT_TO_SHUFFLE_OPPONENTS_CARDS;
    WANT_TO_USE_ABILITY_FROM_PRIZES: GameCardMessage.WANT_TO_USE_ABILITY_FROM_PRIZES;
    WANT_TO_USE_ITEM_FROM_PRIZES: GameCardMessage.WANT_TO_USE_ITEM_FROM_PRIZES;
    WANT_TO_USE_BARRAGE: GameCardMessage.WANT_TO_USE_BARRAGE;
    WHICH_DIRECTION_TO_PLACE_STADIUM: GameCardMessage.WHICH_DIRECTION_TO_PLACE_STADIUM;
    ...
    DISCARD_STADIUM_OR_TOOL: GameCardMessage.DISCARD_STADIUM_OR_TOOL;
    CHOICE_TOOL: GameCardMessage.CHOICE_TOOL;
    CHOICE_SPECIAL_ENERGY: GameCardMessage.CHOICE_SPECIAL_ENERGY;
    CHOICE_STADIUM: GameCardMessage.CHOICE_STADIUM;
    WANT_TO_DISCARD_STADIUM: GameCardMessage.WANT_TO_DISCARD_STADIUM;
    CHOOSE_ITEMS_OR_SUPPORTERS: GameCardMessage.CHOOSE_ITEMS_OR_SUPPORTERS;
    WANT_TO_DRAW_UNTIL_6: GameCardMessage.WANT_TO_DRAW_UNTIL_6;
    WANT_TO_USE_FESTIVAL_FEVER: GameCardMessage.WANT_TO_USE_FESTIVAL_FEVER;
    CANNOT_EVOLVE_ON_YOUR_FIRST_TURN: GameCardMessage.CANNOT_EVOLVE_ON_YOUR_FIRST_TURN;
    WANT_TO_USE_TORRENTIAL_PUMP: GameCardMessage.WANT_TO_USE_TORRENTIAL_PUMP;
    WANT_TO_ATTACH_ONLY_FIGHTING_ENERGY: GameCardMessage.WANT_TO_ATTACH_ONLY_FIGHTING_ENERGY;
    WANT_TO_ATTACH_ONLY_FIRE_ENERGY: GameCardMessage.WANT_TO_ATTACH_ONLY_FIRE_ENERGY;
    WANT_TO_ATTACH_ONLY_WATER_ENERGY: GameCardMessage.WANT_TO_ATTACH_ONLY_WATER_ENERGY;
    WANT_TO_ATTACH_ONE_OF_EACH: GameCardMessage.WANT_TO_ATTACH_ONE_OF_EACH;
    WANT_TO_DISCARD_CARDS: GameCardMessage.WANT_TO_DISCARD_CARDS;
    WANT_TO_ATTACK_AGAIN: GameCardMessage.WANT_TO_ATTACK_AGAIN;
    MULLIGAN_CARDS: GameCardMessage.MULLIGAN_CARDS;
    ...
    DISCARD_FROM_TOP_OF_DECK: GameCardMessage.DISCARD_FROM_TOP_OF_DECK;
    RETURN_TO_TOP_OF_DECK: GameCardMessage.RETURN_TO_TOP_OF_DECK;
    CHOOSE_SUPPORTER_FROM_DECK: GameCardMessage.CHOOSE_SUPPORTER_FROM_DECK;
    CHOOSE_SUPPORTER_FROM_DISCARD: GameCardMessage.CHOOSE_SUPPORTER_FROM_DISCARD;
    SHUFFLE_OPPONENT_HAND: GameCardMessage.SHUFFLE_OPPONENT_HAND;
    SHUFFLE_YOUR_HAND: GameCardMessage.SHUFFLE_YOUR_HAND;
    CHOOSE_CARD_TO_SHUFFLE: GameCardMessage.CHOOSE_CARD_TO_SHUFFLE;
    LABEL_GX_USED: GameCardMessage.LABEL_GX_USED;
    LABEL_VSTAR_USED: GameCardMessage.LABEL_VSTAR_USED;
    ORDER_OPPONENT_DECK: GameCardMessage.ORDER_OPPONENT_DECK;
    ORDER_YOUR_DECK: GameCardMessage.ORDER_YOUR_DECK;
    REVEAL_YOUR_TOP_DECK: GameCardMessage.REVEAL_YOUR_TOP_DECK;
    REVEAL_OPPONENT_TOP_DECK: GameCardMessage.REVEAL_OPPONENT_TOP_DECK;
    REVEAL_RANDOM_CARD_IN_OPPONENT_HAND: GameCardMessage.REVEAL_RANDOM_CARD_IN_OPPONENT_HAND;
    REVEAL_AN_OPPONENT_PRIZES: GameCardMessage.REVEAL_AN_OPPONENT_PRIZES;
    REVEAL_ONE_OF_YOUR_PRIZES: GameCardMessage.REVEAL_ONE_OF_YOUR_PRIZES;
    SEARCH_DECK_FOR_CARD: GameCardMessage.SEARCH_DECK_FOR_CARD;
    FAILED_IMPORTS: GameCardMessage.FAILED_IMPORTS;
    CANNOT_MOVE_DAMAGE: GameCardMessage.CANNOT_MOVE_DAMAGE;
    CANNOT_EVOLVE: GameCardMessage.CANNOT_EVOLVE;
    ABILITY_BLOCKED: GameCardMessage.ABILITY_BLOCKED;
    PLAYER_CARDS_REVEALED_BY_EFFECT: GameCardMessage.PLAYER_CARDS_REVEALED_BY_EFFECT;
    CHOOSE_CARDS: GameCardMessage.CHOOSE_CARDS;
    CHOOSE_ENERGY_FROM_DISCARD: GameCardMessage.CHOOSE_ENERGY_FROM_DISCARD;
    CHOOSE_ENERGY_FROM_DECK: GameCardMessage.CHOOSE_ENERGY_FROM_DECK;
    DISCARD_STADIUM_OR_TOOL_OR_SPECIAL_ENERGY: GameCardMessage.DISCARD_STADIUM_OR_TOOL_OR_SPECIAL_ENERGY;
    CHOOSE_CARD_TO_PUT_ON_BOTTOM: GameCardMessage.CHOOSE_CARD_TO_PUT_ON_BOTTOM;
    FORMAT_ALL: GameCardMessage.FORMAT_ALL;
    FORMAT_STANDARD: GameCardMessage.FORMAT_STANDARD;
    FORMAT_STANDARD_NIGHTLY: GameCardMessage.FORMAT_STANDARD_NIGHTLY;
    FORMAT_EXPANDED: GameCardMessage.FORMAT_EXPANDED;
    FORMAT_UNLIMITED: GameCardMessage.FORMAT_UNLIMITED;
    FORMAT_ETERNAL: GameCardMessage.FORMAT_ETERNAL;
    FORMAT_RETRO: GameCardMessage.FORMAT_RETRO;
    FORMAT_GLC: GameCardMessage.FORMAT_GLC;
    ROCK_PAPER_SCISSORS: GameCardMessage.ROCK_PAPER_SCISSORS;
    ROCK: GameCardMessage.ROCK;
    PAPER: GameCardMessage.PAPER;
    SCISSORS: GameCardMessage.SCISSORS;
    ...
    CHOOSE_PRIZE_CARD_TO_DISCARD: GameStoreMessage.CHOOSE_PRIZE_CARD_TO_DISCARD;
    ...
    NO_CARDS_IN_DECK: GameStoreMessage.NO_CARDS_IN_DECK;
    NO_CARDS_IN_DISCARD: GameStoreMessage.NO_CARDS_IN_DISCARD;
    ...
    CAN_ONLY_ATTACH_TO_PSYCHIC: GameStoreMessage.CAN_ONLY_ATTACH_TO_PSYCHIC;
    SETUP_CARDS_AVAILABLE: GameStoreMessage.SETUP_CARDS_AVAILABLE;
    USE_SETUP_CARDS: GameStoreMessage.USE_SETUP_CARDS;
    MULLIGAN: GameStoreMessage.MULLIGAN;
    CHOOSE_PRIZES_SETUP: GameStoreMessage.CHOOSE_PRIZES_SETUP;
    ...
    ERROR_BOT_FORMAT_NOT_ALLOWED: GameCoreError.ERROR_BOT_FORMAT_NOT_ALLOWED;
