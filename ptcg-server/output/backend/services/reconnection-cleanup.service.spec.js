...
describe('ReconnectionCleanupService', () => {
    ...
    beforeEach(() => {
        ...
        mockGameStatePreserver.cleanupExpiredSessions.and.returnValue(Promise.resolve(5));
        mockGameStatePreserver.removePreservedState.and.returnValue(Promise.resolve());
        mockGameStatePreserver.getConfig.and.returnValue({});
        ...
        mockConfigManager.getCurrentConfig.and.returnValue({});
        cleanupService = new reconnection_cleanup_service_1.ReconnectionCleanupService(mockGameStatePreserver, mockConfigManager, mockConfig);
    });
    describe('constructor', () => {
        ...
        it('should initialize with default configuration when no config provided', () => {
            const service = new reconnection_cleanup_service_1.ReconnectionCleanupService(mockGameStatePreserver, mockConfigManager);
    ...
    describe('cleanupOrphanedGameStates', () => {
        ...
        it('should handle errors from GameStatePreserver', async () => {
            mockGameStatePreserver.cleanupExpiredSessions.and.returnValue(Promise.reject(new Error('Preserver error')));
            const result = await cleanupService.cleanupOrphanedGameStates();
    ...
    describe('forceCleanupUserSessions', () => {
        beforeEach(() => {
            ...
            spyOn(disconnected_session_1.DisconnectedSession, 'find')
