...
exports.ReconnectionConfigValidator = void 0;
const logger_1 = require("../../utils/logger");
class ReconnectionConfigValidator {
    /**
     ...
     */
    static mergeAndValidateConfig(partialConfig, options = {}) {
        const defaultConfig = this.getDefaultConfig();
        const mergedConfig = Object.assign(Object.assign({}, defaultConfig), partialConfig);
        const validation = this.validateConfig(mergedConfig, Object.assign(Object.assign({}, options), { allowPartialConfig: false }));
        return {
            config: mergedConfig,
            validation
        };
     ...
     */
    static validateResourceConstraints(config, resourceMetrics) {
        const result = {
            isValid: true,
            errors: [],
            warnings: []
...
exports.ReconnectionConfigValidator = ReconnectionConfigValidator;
ReconnectionConfigValidator.MIN_PRESERVATION_TIMEOUT = 30 * 1000; // 30 seconds
ReconnectionConfigValidator.MAX_PRESERVATION_TIMEOUT = 30 * 60 * 1000; // 30 minutes
ReconnectionConfigValidator.MIN_RECONNECT_ATTEMPTS = 1;
ReconnectionConfigValidator.MAX_RECONNECT_ATTEMPTS = 10;
ReconnectionConfigValidator.MIN_INTERVAL = 1000; // 1 second
ReconnectionConfigValidator.MAX_INTERVAL = 60 * 1000; // 1 minute
ReconnectionConfigValidator.MIN_HEALTH_CHECK_INTERVAL = 5 * 1000; // 5 seconds
ReconnectionConfigValidator.MAX_HEALTH_CHECK_INTERVAL = 5 * 60 * 1000; // 5 minutes
ReconnectionConfigValidator.MIN_CLEANUP_INTERVAL = 10 * 1000; // 10 seconds
ReconnectionConfigValidator.MAX_CLEANUP_INTERVAL = 10 * 60 * 1000; // 10 minutes
ReconnectionConfigValidator.MIN_MAX_SESSIONS = 1;
ReconnectionConfigValidator.MAX_MAX_SESSIONS = 5;
