...
describe('ReconnectionConfigManager', () => {
    ...
    let validConfig;
    beforeEach(() => {
        validConfig = reconnection_config_validator_1.ReconnectionConfigValidator.getDefaultConfig();
        configManager = new reconnection_config_manager_1.ReconnectionConfigManager(validConfig);
    });
    afterEach(() => {
    ...
    describe('constructor', () => {
        ...
        it('should throw error for invalid initial configuration', () => {
            const invalidConfig = Object.assign(Object.assign({}, validConfig), { preservationTimeoutMs: -1000 });
            expect(() => new reconnection_config_manager_1.ReconnectionConfigManager(invalidConfig)).toThrow('Invalid initial configuration');
        });
