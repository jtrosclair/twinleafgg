...
describe('Notification System Integration', () => {
    describe('GameSocket Notification Methods', () => {
        it('should have all required notification methods', () => {
            ...
            const mockCore = { games: [] };
            const mockCache = {};
            const gameSocket = new game_socket_1.GameSocket(mockClient, mockSocket, mockCore, mockCache);
    ...
    describe('SocketClient Notification Methods', () => {
        it('should have all required notification methods', () => {
            ...
            const socketClient = new socket_client_1.SocketClient(mockUser, mockCore, mockIo, mockSocket);
            // Verify all notification methods exist
    ...
    describe('Notification Event Names', () => {
        it('should use consistent event naming pattern', () => {
            ...
            const mockDisconnectedClient = { id: 2, name: 'Player2' };
