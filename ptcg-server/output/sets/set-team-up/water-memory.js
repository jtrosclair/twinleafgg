...
exports.WaterMemory = void 0;
const trainer_card_1 = require("../../game/store/card/trainer-card");
const card_types_1 = require("../../game/store/card/card-types");
const game_1 = require("../../game");
const check_effects_1 = require("../../game/store/effects/check-effects");
const prefabs_1 = require("../../game/store/prefabs/prefabs");
class WaterMemory extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
        ...
        this.name = 'Water Memory';
        this.fullName = 'Water Memory TEU';
        this.text = 'The Silvally-GX this card is attached to is a Water Pokémon.';
    }
...
exports.WaterMemory = WaterMemory;
