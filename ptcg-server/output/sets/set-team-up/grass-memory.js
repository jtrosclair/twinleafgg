...
exports.GrassMemory = void 0;
const trainer_card_1 = require("../../game/store/card/trainer-card");
const card_types_1 = require("../../game/store/card/card-types");
const game_1 = require("../../game");
const check_effects_1 = require("../../game/store/effects/check-effects");
const prefabs_1 = require("../../game/store/prefabs/prefabs");
class GrassMemory extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
        ...
        this.name = 'Grass Memory';
        this.fullName = 'Grass Memory TEU';
        this.text = 'The Silvally-GX this card is attached to is a Grass Pokémon.';
    }
    ...
    reduceEffect(store, state, effect) {
        if (effect instanceof check_effects_1.CheckPokemonTypeEffect) {
            ...
            // Replace the type with Grass
            effect.cardTypes = [card_types_1.CardType.GRASS];
        }
        return state;
    }
}
exports.GrassMemory = GrassMemory;
