...
class LuxrayGLLVX extends pokemon_card_1.PokemonCard {
    constructor() {
        super(...arguments);
        this.stage = card_types_1.Stage.LV_X;
        this.evolvesFrom = 'Luxray GL';
        this.cardType = L;
        ...
        this.setNumber = '109';
        this.name = 'Luxray GL';
        this.fullName = 'Luxray GL LV.X RR';
    }
...
exports.LuxrayGLLVX = LuxrayGLLVX;
