...
class Rattata extends pokemon_card_1.PokemonCard {
    ...
    reduceEffect(store, state, effect) {
        if (effect instanceof play_card_effects_1.PlayPokemonEffect && effect.pokemonCard === this) {
            (0, prefabs_1.REMOVE_MARKER)(this.TRICKERY_MARKER, effect.player, this);
        }
        if ((0, prefabs_1.WAS_POWER_USED)(effect, 0, this)) {
            const player = effect.player;
            if ((0, prefabs_1.HAS_MARKER)(this.TRICKERY_MARKER, player, this)) {
                throw new game_1.GameError(game_1.GameMessage.POWER_ALREADY_USED);
            }
            (0, prefabs_1.BLOCK_IF_ASLEEP_CONFUSED_PARALYZED)(player, this);
            (0, prefabs_1.ADD_MARKER)(this.TRICKERY_MARKER, player, this);
        ...
        (0, prefabs_1.REMOVE_MARKER_AT_END_OF_TURN)(effect, this.TRICKERY_MARKER, this);
