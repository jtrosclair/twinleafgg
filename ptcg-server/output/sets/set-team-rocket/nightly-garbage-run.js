...
exports.NightlyGarbageRun = void 0;
...
class NightlyGarbageRun extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
        this.trainerType = card_types_1.TrainerType.ITEM;
        this.tags = [card_types_1.CardTag.ROCKETS_SECRET_MACHINE];
        this.set = 'TR';
        this.name = 'Nightly Garbage Run';
        this.fullName = 'Nightly Garbage Run TR';
        this.cardImage = 'assets/cardback.png';
        this.setNumber = '77';
        this.text = 'Choose up to 3 Basic Pokémon cards, Evolution cards, and/or basic Energy cards from your discard pile. ' +
...
exports.NightlyGarbageRun = NightlyGarbageRun;
