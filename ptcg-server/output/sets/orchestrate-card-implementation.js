...
function getExistingCardExamples(setCode, category) {
    ...
    const files = readdirSync(folderPath).filter((f) => f.endsWith('.ts') && f !== 'index.ts' && f !== 'other-prints.ts');
    return files.slice(0, 3).map((f) => join(folder, f));
}
function generatePromptForCard(card, tcgdexData) {
    var _a, _b, _c, _d;
    const category = (tcgdexData === null || tcgdexData === void 0 ? void 0 : tcgdexData.category) || 'Pokemon';
    ...
    prompt += `- **Name:** ${(tcgdexData === null || tcgdexData === void 0 ? void 0 : tcgdexData.name) || card.name}\n`;
    prompt += `- **Set:** ${card.setCode}\n`;
    prompt += `- **Number:** ${card.setNumber}\n`;
    prompt += `- **Category:** ${category}\n`;
    if (isPokemon) {
        prompt += `- **HP:** ${(tcgdexData === null || tcgdexData === void 0 ? void 0 : tcgdexData.hp) || 'Unknown'}\n`;
        prompt += `- **Type:** ${((_a = tcgdexData === null || tcgdexData === void 0 ? void 0 : tcgdexData.types) === null || _a === void 0 ? void 0 : _a.join(', ')) || 'Unknown'}\n`;
        prompt += `- **Stage:** ${(tcgdexData === null || tcgdexData === void 0 ? void 0 : tcgdexData.stage) || 'Basic'}\n`;
        if (tcgdexData === null || tcgdexData === void 0 ? void 0 : tcgdexData.evolveFrom) {
            prompt += `- **Evolves From:** ${tcgdexData.evolveFrom}\n`;
        }
        if ((_b = tcgdexData === null || tcgdexData === void 0 ? void 0 : tcgdexData.abilities) === null || _b === void 0 ? void 0 : _b.length) {
            prompt += `\n### Abilities\n`;
            for (const ability of tcgdexData.abilities) {
                prompt += `- **${ability.name}** (${ability.type || 'Ability'}): ${ability.effect || 'No effect text'}\n`;
            }
        }
        if ((_c = tcgdexData === null || tcgdexData === void 0 ? void 0 : tcgdexData.attacks) === null || _c === void 0 ? void 0 : _c.length) {
            prompt += `\n### Attacks\n`;
            for (const attack of tcgdexData.attacks) {
                const cost = ((_d = attack.cost) === null || _d === void 0 ? void 0 : _d.join('')) || 'Free';
        ...
        prompt += `- **Trainer Type:** ${(tcgdexData === null || tcgdexData === void 0 ? void 0 : tcgdexData.trainerType) || 'Item'}\n`;
        if (tcgdexData === null || tcgdexData === void 0 ? void 0 : tcgdexData.effect) {
            prompt += `\n### Effect\n${tcgdexData.effect}\n`;
        }
    }
    else if (isEnergy) {
        prompt += `- **Energy Type:** ${(tcgdexData === null || tcgdexData === void 0 ? void 0 : tcgdexData.energyType) || 'Special'}\n`;
        if (tcgdexData === null || tcgdexData === void 0 ? void 0 : tcgdexData.effect) {
            prompt += `\n### Effect\n${tcgdexData.effect}\n`;
        }
    }
