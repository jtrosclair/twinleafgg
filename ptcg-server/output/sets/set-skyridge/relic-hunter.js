...
exports.RelicHunter = void 0;
const game_1 = require("../../game");
const play_card_effects_1 = require("../../game/store/effects/play-card-effects");
const prefabs_1 = require("../../game/store/prefabs/prefabs");
class RelicHunter extends game_1.TrainerCard {
    constructor() {
        super(...arguments);
        ...
        this.set = 'SK';
        this.setNumber = '120';
        this.name = 'Relic Hunter';
        this.fullName = 'Relic Hunter SK';
        this.text = 'Search your deck for up to 2 Supporter and/or Stadium cards, show them to your opponent, and put them into your hand. Shuffle your deck afterward.';
    }
...
exports.RelicHunter = RelicHunter;
