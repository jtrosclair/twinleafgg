...
class Charmeleon extends pokemon_card_1.PokemonCard {
    constructor() {
        ...
        this.fullName = 'Charmeleon DRM';
    }
    reduceEffect(store, state, effect) {
        // Ability: Burning Fighter (on-evolve)
        // Refs: set-burning-shadows/rhyperior.ts (Toppling Wind - on-evolve discard), set-forbidden-light/abomasnow.ts (Blessings of the Frost - on-evolve attach energy)
