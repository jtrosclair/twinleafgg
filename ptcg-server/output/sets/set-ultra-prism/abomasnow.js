...
class Abomasnow extends pokemon_card_1.PokemonCard {
    constructor() {
        ...
        this.name = 'Abomasnow';
        this.fullName = 'Abomasnow UPR';
    }
    reduceEffect(store, state, effect) {
        // Ability: Blessings of the Frost
        // Ref: set-crimson-invasion/nihilego-gx.ts (Empty Light - PlayPokemonEffect on-play pattern)
        if ((0, prefabs_1.JUST_EVOLVED)(effect, this)) {
            const player = effect.player;
            if ((0, prefabs_1.IS_ABILITY_BLOCKED)(store, state, player, this)) {
                return state;
            }
            const hasWaterEnergy = player.discard.cards.some(c => c instanceof game_1.EnergyCard && c.energyType === card_types_1.EnergyType.BASIC && c.provides.includes(card_types_1.CardType.WATER));
            if (!hasWaterEnergy) {
                return state;
            }
