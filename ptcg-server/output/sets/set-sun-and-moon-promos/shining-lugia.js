...
class ShiningLugia extends pokemon_card_1.PokemonCard {
    ...
    reduceEffect(store, state, effect) {
        ...
        if (effect instanceof game_effects_1.AttackEffect && effect.attack === this.attacks[1]) {
            ...
            state = store.prompt(state, new game_2.ChooseEnergyPrompt(player.id, game_message_1.GameMessage.CHOOSE_ENERGIES_TO_DISCARD, checkProvidedEnergy.energyMap, [C], { allowCancel: false }), energy => {
