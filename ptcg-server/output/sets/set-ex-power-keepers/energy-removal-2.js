...
function* playCard(next, store, state, effect) {
    ...
    let cards = [];
    yield store.prompt(state, new game_1.ChooseCardsPrompt(player, game_1.GameMessage.CHOOSE_CARD_TO_DISCARD, target.energies, {}, { min: 1, max: 1, allowCancel: false }), selected => {
        cards = selected;
        next();
    });
...
class EnergyRemoval2 extends trainer_card_1.TrainerCard {
    constructor() {
        ...
        this.set = 'PK';
        this.name = 'Energy Removal 2';
        this.fullName = 'Energy Removal 2 PK';
...
exports.EnergyRemoval2 = EnergyRemoval2;
