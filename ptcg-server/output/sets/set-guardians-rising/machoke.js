...
class Machoke extends pokemon_card_1.PokemonCard {
    ...
    reduceEffect(store, state, effect) {
        ...
        if (effect instanceof attack_effects_1.PutDamageEffect) {
            ...
            const defendingPlayer = __1.StateUtils.findOwner(state, effect.target);
            // Find the owner of the source (the attacking player)
            const attackingPlayer = __1.StateUtils.findOwner(state, effect.source);
            ...
            defendingPlayer.forEachPokemon(__1.PlayerType.BOTTOM_PLAYER, (cardList, card, target) => {
