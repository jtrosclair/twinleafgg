...
exports.setGuardiansRising = [
    ...
    new other_prints_2.EnhancedHammerGRI(),
    new other_prints_2.EnergyLotoGRI(),
    new other_prints_2.FieldBlowerGRI(),
    new other_prints_2.FieldBlowerGRI2(),
    new other_prints_2.MaxPotionGRI(),
    new other_prints_2.MaxPotionGRI2(),
    new other_prints_2.MaxPotionGRI3(),
    new other_prints_2.RescueStretcherGRI(),
