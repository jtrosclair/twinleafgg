...
class Zygarde2 extends pokemon_card_1.PokemonCard {
    constructor() {
        ...
        this.retreat = [C, C];
        this.BLOCK_RETREAT_MARKER = 'ZYGARDE2_FCO_BLOCK_RETREAT';
        this.attacks = [
            {
                name: 'Rumble',
                cost: [F, C],
    ...
    reduceEffect(store, state, effect) {
        ...
        (0, prefabs_1.BLOCK_RETREAT_IF_MARKER)(effect, this.BLOCK_RETREAT_MARKER, this);
        (0, prefabs_1.REMOVE_MARKER_FROM_ACTIVE_AT_END_OF_TURN)(effect, this.BLOCK_RETREAT_MARKER, this);
        // Attack 2: Geostrike
