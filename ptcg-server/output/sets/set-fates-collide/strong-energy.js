...
class StrongEnergy extends energy_card_1.EnergyCard {
    constructor() {
        ...
        this.fullName = 'Strong Energy FCO';
        this.cardImage = 'assets/cardback.png';
        this.setNumber = '115';
        this.STRONG_ENERGY_MAREKER = 'STRONG_ENERGY_MAREKER';
        this.text = 'This card can only be attached to [F] Pokemon. This card provides [F] Energy only while this card is attached to a [F] Pokemon.' +
            '\n\n' +
