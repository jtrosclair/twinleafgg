...
exports.PalmersContribution = void 0;
...
function* playCard(next, store, state, self, effect) {
    ...
    let cards = [];
    yield store.prompt(state, new choose_cards_prompt_1.ChooseCardsPrompt(player, game_message_1.GameMessage.CHOOSE_CARD_TO_DECK, player.discard, {}, { min: 0, max: 5, allowCancel: false, blocked }), selected => {
        cards = selected || [];
        next();
    });
...
class PalmersContribution extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
        ...
        this.setNumber = '139';
        this.name = 'Palmer\'s Contribution';
        this.fullName = 'Palmer\'s Contribution SV';
        this.text = 'Search your discard pile for up to 5 in any combination of Pokémon and basic Energy cards. Show them to your opponent and shuffle them into your deck.';
    }
...
exports.PalmersContribution = PalmersContribution;
