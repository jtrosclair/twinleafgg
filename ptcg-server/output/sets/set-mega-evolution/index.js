...
const houndstone_1 = require("./houndstone");
...
const lillies_determination_1 = require("./lillies-determination");
...
const mega_gardevoir_ex_1 = require("./mega-gardevoir-ex");
const mega_kangaskhan_ex_1 = require("./mega-kangaskhan-ex");
const mega_latias_ex_1 = require("./mega-latias-ex");
const mega_lucario_ex_1 = require("./mega-lucario-ex");
const mega_manectric_ex_1 = require("./mega-manectric-ex");
const mega_mawile_ex_1 = require("./mega-mawile-ex");
const meganium_1 = require("./meganium");
const mega_signal_1 = require("./mega-signal");
const mega_venusaur_ex_1 = require("./mega-venusaur-ex");
const mystery_garden_1 = require("./mystery-garden");
...
exports.setMegaEvolution = [
    ...
    new kyogre_1.Kyogre(),
    new latios_1.Latios(),
    new lillies_determination_1.LilliesDetermination(),
    ...
    new mega_gardevoir_ex_1.MegaGardevoirex(),
    new mega_kangaskhan_ex_1.MegaKangaskhanex(),
    new mega_latias_ex_1.MegaLatiasex(),
    new mega_lucario_ex_1.MegaLucarioex(),
    new mega_manectric_ex_1.MegaManectricEx(),
    new mega_mawile_ex_1.MegaMawileEx(),
    new meganium_1.Meganium(),
    new mega_signal_1.MegaSignal(),
    new mega_venusaur_ex_1.MegaVenusaurEx(),
    new mystery_garden_1.MysteryGarden(),
    new nacli_1.Nacli(),
    ...
    // new RareCandyM1S(),
    new other_prints_1.BossOrdersMEG(),
    new other_prints_1.EnergySwitchPKMEG(),
    new other_prints_1.RareCandyMEG(),
    new other_prints_1.SwitchMEG(),
    new other_prints_1.UltraBallMEG(),
    new other_prints_1.Bulbasaur2MEG(),
    new other_prints_1.Ivysaur2MEG(),
    new other_prints_1.Ninjask2MEG(),
    new other_prints_1.Snover2MEG(),
    new other_prints_1.Clawitizer2MEG(),
    new other_prints_1.Inteleon2MEG(),
    new other_prints_1.Houndstone2MEG(),
    new other_prints_1.Garganacl2MEG(),
    new other_prints_1.Steelix2MEG(),
    new other_prints_1.Gumshoos2MEG(),
    new other_prints_1.MegaVenusaurEx2MEG(),
    new other_prints_1.MegaCameruptEx2MEG(),
    new other_prints_1.MegaAbomasnowEx2MEG(),
    new other_prints_1.MegaManectricEx2MEG(),
    new other_prints_1.MegaGardevoirex2MEG(),
    new other_prints_1.MegaLucarioex2MEG(),
    new other_prints_1.MegaAbsolex2MEG(),
    new other_prints_1.MegaMawileEx2MEG(),
    new other_prints_1.MegaLatiasex2MEG(),
    new other_prints_1.MegaKangaskhanex2MEG(),
    new other_prints_1.AirBalloonMEG(),
    new other_prints_1.BuddyBuddyPoffinMEG(),
    new other_prints_1.FightingGong2MEG(),
    new other_prints_1.LilliesDetermination2MEG(),
    new other_prints_1.MegaSignal2MEG(),
    new other_prints_1.MysteryGarden2MEG(),
    new other_prints_1.NightlyStretcherMEG(),
    new other_prints_1.PowerProtein2MEG(),
    new other_prints_1.RareCandy2MEG(),
    new other_prints_1.WallysCompassion2MEG(),
    new other_prints_1.MegaVenusaurEx3MEG(),
    new other_prints_1.MegaGardevoirex3MEG(),
    new other_prints_1.MegaLucarioex3MEG(),
    new other_prints_1.MegaAbsolex3MEG(),
    new other_prints_1.MegaLatiasex3MEG(),
    new other_prints_1.MegaKangaskhanex3MEG(),
    new other_prints_1.LilliesDetermination3MEG(),
    new other_prints_1.WallysCompassion3MEG(),
    new other_prints_1.MegaGardevoirex4MEG(),
    new other_prints_1.MegaLucarioex4MEG(),
];
