...
exports.setCelestialStorm = [
    ...
    // Other Prints
    new other_prints_2.AcroBikeCES(),
    new other_prints_2.AcroBikeCESAlt(),
    new other_prints_2.AcroBikeCESSR(),
    new other_prints_2.SuperScoopUpCES(),
    new other_prints_2.SwitchCES(),
    new other_prints_1.BillsMaintenanceCES(),
    new other_prints_1.EnergySwitchPKCES(),
    new other_prints_1.PokeNavCES(),
    new other_prints_1.RareCandyCES(),
    new other_prints_1.TvReporterCES(),
    new other_prints_1.RainbowEnergyPLCES(),
    new other_prints_1.ArticunoGX2CES(),
    new other_prints_1.ElectrodeGX2CES(),
    new other_prints_1.BanetteGX2CES(),
    new other_prints_1.RayquazaGX2CES(),
    new other_prints_1.ApricornMaker2CES(),
    new other_prints_1.BillsMaintenance2CES(),
    new other_prints_1.Copycat2CES(),
    new other_prints_1.StevensResolve2CES(),
    new other_prints_1.TateAndLiza3CES(),
    new other_prints_1.TvReporter2CES(),
    new other_prints_1.ArticunoGX3CES(),
    new other_prints_1.ElectrodeGX3CES(),
    new other_prints_1.BanetteGX3CES(),
    new other_prints_1.RayquazaGX3CES(),
    new other_prints_1.HustleBelt2CES(),
    new other_prints_1.PokeNav2CES(),
    new other_prints_1.RainbowEnergyPL2CES(),
    new other_prints_1.Sceptile2CES(),
    new other_prints_1.TateAndLiza2CES(),
    new other_prints_1.RayquazaGX4CES(),
];
