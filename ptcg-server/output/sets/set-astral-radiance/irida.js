...
function* playCard(next, store, state, self, effect) {
    ...
    yield store.prompt(state, new choose_cards_prompt_1.ChooseCardsPrompt(player, game_message_1.GameMessage.CHOOSE_CARD_TO_HAND, player.deck, {}, { min: 0, max: count, allowCancel: false, blocked, maxPokemons, maxItems: maxItemsOrTools }), selected => {
        cards = selected || [];
        next();
    });
