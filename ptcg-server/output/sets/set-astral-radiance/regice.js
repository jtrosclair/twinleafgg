...
function* useRegiGate(next, store, state, effect, self) {
...
class Regice extends pokemon_card_1.PokemonCard {
    ...
    reduceEffect(store, state, effect) {
        ...
        if (effect instanceof game_effects_1.UseAttackEffect && effect.player.active.marker.hasMarker(this.DEFENDING_POKEMON_CANNOT_ATTACK_MARKER, this)) {
            ...
            if (pokemonCard && pokemonCard.tags.includes(card_types_1.CardTag.POKEMON_V) || pokemonCard && pokemonCard.tags.includes(card_types_1.CardTag.POKEMON_VSTAR) || pokemonCard && pokemonCard.tags.includes(card_types_1.CardTag.POKEMON_VMAX) || pokemonCard && pokemonCard.tags.includes(card_types_1.CardTag.POKEMON_VUNION)) {
