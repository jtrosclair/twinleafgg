...
const dondozo_1 = require("./dondozo");
...
const spidops_ex_1 = require("./spidops-ex");
...
exports.setScarletAndViolet = [
    ...
    new riolu_1.Riolu(),
    new riolu2_1.Riolu2(),
    new rock_chestplate_1.RockChestplate(),
    ...
    new full_art_1.LightningEnergyHR(),
    new full_art_1.GardevoirexFA(),
    new full_art_1.GardevoirexSIR(),
    ...
    new full_art_1.MagnezoneexFA(),
    new full_art_1.MiraidonexFA(),
    new full_art_1.MiraidonexSIR(),
    new full_art_1.MiraidonexHR(),
    new full_art_1.MiriamFA(),
    new full_art_1.MiriamSIR(),
    new full_art_1.NestBallHR(),
    new full_art_1.PennyFA(),
    new full_art_1.PennySIR(),
    new full_art_1.ProfessorsResearchFA1(),
    new full_art_1.ProfessorsResearchFA2(),
