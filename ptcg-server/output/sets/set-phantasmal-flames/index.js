...
const grimsleys_gambit_1 = require("./grimsleys-gambit");
const haunter_1 = require("./haunter");
const jigglypuff_1 = require("./jigglypuff");
const jumbo_ice_1 = require("./jumbo-ice");
...
const sacred_charm_1 = require("./sacred-charm");
...
exports.setPhantasmalFlames = [
    ...
    new grimsleys_gambit_1.GrimsleysGambit(),
    new haunter_1.Haunter(),
    new jigglypuff_1.Jigglypuff(),
    new jumbo_ice_1.JumboIce(),
    new lombre_1.Lombre(),
    new lotad_1.Lotad(),
    ...
    new wonder_patch_1.WonderPatch(),
    new zacian_1.Zacian(),
    new other_prints_1.Ludicolo2PFL(),
    new other_prints_1.Zacian2PFL(),
    new other_prints_1.Toxtricity2PFL(),
    new other_prints_1.Wigglytuff2PFL(),
    new other_prints_1.MegaCharizardXex2PFL(),
    new other_prints_1.Oricorioex2PFL(),
    new other_prints_1.Rotomex2PFL(),
    new other_prints_1.MegaSharpedoex2PFL(),
    new other_prints_1.MegaLopunnyex2PFL(),
    new other_prints_1.BattleColosseum2PFL(),
    new other_prints_1.Dawn2PFL(),
    new other_prints_1.Firebreather2PFL(),
    new other_prints_1.GrimsleysGambit2PFL(),
    new other_prints_1.SacredCharm2PFL(),
    new other_prints_1.SwitchPFL(),
    new other_prints_1.IgnitionEnergyPFL(),
    new other_prints_1.MegaCharizardXex3PFL(),
    new other_prints_1.Rotomex3PFL(),
