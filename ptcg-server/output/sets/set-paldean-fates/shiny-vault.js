...
class KilowattrelSV extends kilowattrel_1.Kilowattrel {
    constructor() {
        ...
        this.setNumber = '146';
        this.set = 'PAF';
        this.fullName = 'KilowattrelSV PAF';
    }
}
...
class GardevoirexSV extends gardevoir_ex_1.Gardevoirex {
    constructor() {
        ...
        this.setNumber = '217';
        this.set = 'PAF';
        this.fullName = 'Gardevoir exSV PAF';
    }
}
...
class NoivernexSV extends noivern_ex_1.Noivernex {
    constructor() {
        ...
        this.setNumber = '220';
        this.set = 'PAF';
        this.fullName = 'Noivern exSV PAF';
    }
}
...
class SquawkabillyexSV extends squawkabilly_ex_1.Squawkabillyex {
    constructor() {
        ...
        this.setNumber = '223';
        this.set = 'PAF';
        this.fullName = 'Squawkabilly exSV PAF';
    }
}
