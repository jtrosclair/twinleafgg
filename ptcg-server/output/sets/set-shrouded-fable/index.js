...
const janines_secret_technique_1 = require("./janines-secret-technique");
...
const power_hourglass_1 = require("./power-hourglass");
...
exports.setShroudedFable = [
    new absol_1.Absol(),
    new axew_1.Axew(),
    new binding_mochi_1.BindingMochi(),
    new bloodmoon_ursaluna_1.BloodmoonUrsaluna(),
    new cassiopeia_1.Cassiopeia(),
    ...
    new janines_secret_technique_1.JaninesSecretTechnique(),
    new joltik_1.Joltik(),
    new kingdra_ex_1.Kingdraex(),
    new kyurem_1.Kyurem(),
    new munkidori_ex_1.Munkidoriex(),
    new neutral_center_1.NeutralCenter(),
    new night_time_academy_1.NightTimeAcademy(),
    new nightly_stretcher_1.NightlyStretcher(),
    new okidogi_ex_1.Okidogiex(),
    new pecharunt_ex_1.Pecharuntex(),
    new pokevital_a_1.PokeVitalA(),
    new power_hourglass_1.PowerHourglass(),
