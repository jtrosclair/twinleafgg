    ...
    reduceEffect(store, state, effect) {
        ...
        if ((0, prefabs_1.WAS_POWER_USED)(effect, 0, this)) {
            ...
            player.forEachPokemon(game_1.PlayerType.BOTTOM_PLAYER, (cardList, card) => {
                if (card !== this) {
                    pokemonCount += 1;
                    const hasAttachedEnergy = cardList.cards.some(c => c.superType === card_types_1.SuperType.ENERGY && (c.provides.includes(card_types_1.CardType.GRASS) || c.provides.includes(card_types_1.CardType.ANY)));
