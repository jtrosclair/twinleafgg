...
class Cascoon extends pokemon_card_1.PokemonCard {
    constructor() {
        ...
        this.name = 'Cascoon';
        this.fullName = 'Cascoon ROS';
        this.PREVENT_DAMAGE_MARKER = 'CASCOON_ROS_PREVENT_DAMAGE_MARKER';
        this.CLEAR_PREVENT_DAMAGE_MARKER = 'CASCOON_ROS_CLEAR_PREVENT_DAMAGE_MARKER';
    }
