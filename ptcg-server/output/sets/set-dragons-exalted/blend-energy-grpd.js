...
class BlendEnergyGRPD extends energy_card_1.EnergyCard {
    constructor() {
        ...
        this.text = 'This card provides [C] Energy. When this card is attached to a Pokemon, this card provides [G], [R], [P], or [D] Energy but provides only 1 Energy at a time.';
