...
class RegisteelEx2 extends pokemon_card_1.PokemonCard {
    constructor() {
        super(...arguments);
        ...
        this.fullName = 'Registeel-EX DRX 122';
        this.DURING_OPPONENTS_NEXT_TURN_TAKE_LESS_DAMAGE_MARKER = 'REGISTEEL2_TAKE_LESS_DAMAGE_MARKER';
        this.CLEAR_DURING_OPPONENTS_NEXT_TURN_TAKE_LESS_DAMAGE_MARKER = 'REGISTEEL2_CLEAR_TAKE_LESS_DAMAGE_MARKER';
    }
    reduceEffect(store, state, effect) {
        // Attack 1: Triple Laser - 30 damage to 3 of opponent's Pokemon
        if ((0, prefabs_1.WAS_ATTACK_USED)(effect, 0, this)) {
            (0, prefabs_1.THIS_ATTACK_DOES_X_DAMAGE_TO_X_OF_YOUR_OPPONENTS_POKEMON)(30, effect, store, state, 3, 3);
        }
...
exports.RegisteelEx2 = RegisteelEx2;
