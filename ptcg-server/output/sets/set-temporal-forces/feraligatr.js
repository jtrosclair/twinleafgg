...
class Feraligatr extends pokemon_card_1.PokemonCard {
    ...
    reduceEffect(store, state, effect) {
        ...
        if (effect instanceof game_effects_1.AttackEffect && effect.source.cards.includes(this) && prefabs_1.HAS_MARKER(this.TORRENTIAL_HEART_MARKER, effect.player, this)) {
            effect.damage += 120;
        }
        ...
        if (prefabs_1.WAS_POWER_USED(effect, 0, this)) {
            ...
            if (cardList instanceof game_1.PokemonCardList) {
                cardList.damage += 50;
                prefabs_1.ADD_MARKER(this.TORRENTIAL_HEART_MARKER, effect.player, this);
