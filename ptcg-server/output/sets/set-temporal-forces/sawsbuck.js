...
class Sawsbuck extends game_1.PokemonCard {
    ...
    reduceEffect(store, state, effect) {
        ...
        if (effect instanceof game_effects_1.PowerEffect && effect.power === this.powers[0]) {
            ...
            if (prefabs_1.HAS_MARKER(this.CHANGING_SEASONS_MARKER, player, this)) {
                throw new game_1.GameError(game_1.GameMessage.POWER_ALREADY_USED);
            }
            prefabs_1.ABILITY_USED(player, this);
            prefabs_1.ADD_MARKER(this.CHANGING_SEASONS_MARKER, player, this);
            const blocked = [];
            ...
            prefabs_1.SEARCH_DECK_FOR_CARDS_TO_HAND(store, state, player, this, { superType: game_1.SuperType.TRAINER }, { min: 0, max: 1, allowCancel: false }, this.powers[0]);
        }
        prefabs_1.REMOVE_MARKER_AT_END_OF_TURN(effect, this.CHANGING_SEASONS_MARKER, this);
        return state;
    }
}
