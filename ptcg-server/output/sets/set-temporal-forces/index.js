...
exports.setTemporalForces = [
    ...
    new chatot_1.Chatot(),
    new cincinno_1.Cinccino(),
    new croconaw_1.Croconaw(),
    new cryptomaniacs_deciphering_1.CiphermaniacsCodebreaking(),
    new delivery_box_1.DeliveryBox(),
    new drilbur_1.Drilbur(),
    new drums_of_awakening_1.DrumsOfAwakening(),
    new dudunsparce_1.Dudunsparce(),
    new dunsparce_1.Dunsparce(),
    new duosion_1.Duosion(),
    new emergency_board_1.EmergencyBoard(),
    new eri_1.Eri(),
    new explorers_guidance_1.ExplorersGuidance(),
    ...
    new great_tusk_1.GreatTusk(),
    new grotle_1.Grotle(),
    new grubbin_1.Grubbin(),
    new hand_trimmer_1.HandTrimmer(),
    ...
    new iron_leaves_ex_1.IronLeavesex(),
    ...
    new miraidon_1.Miraidon(),
    new mist_energy_1.MistEnergy(),
    new mortys_conviction_1.MortysConviction(),
