...
class LuxrayGlLvX extends pokemon_card_1.PokemonCard {
    constructor() {
        ...
        this.name = 'Luxray GL LV.X';
        this.fullName = 'Luxray GL LV.X CEL';
    }
    reduceEffect(store, state, effect) {
        ...
        if (effect instanceof check_effects_1.CheckPokemonAttacksEffect) {
            ...
            for (const evolutionCard of cardList.cards) {
                if (evolutionCard.superType === card_types_1.SuperType.POKEMON && evolutionCard !== this && evolutionCard.name === 'Luxray GL') {
