...
exports.setTwilightMasquerade = [
    ...
    new boomerang_energy_1.BoomerangEnergy(),
    new feebas_1.Feebas(),
    new girafarig_1.Girafarig(),
    new farigiraf_1.Farigiraf(),
