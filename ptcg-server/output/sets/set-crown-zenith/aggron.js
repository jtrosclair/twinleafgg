...
class Aggron extends game_1.PokemonCard {
    ...
    reduceEffect(store, state, effect) {
        if ((0, prefabs_1.WAS_ATTACK_USED)(effect, 0, this)) {
            ...
            (0, prefabs_1.ADD_MARKER)(this.COUNTER_PRESS_MARKER, cardList, this);
            (0, prefabs_1.ADD_MARKER)(this.CLEAR_COUNTER_PRESS_MARKER, opponent, this);
        }
        if ((effect instanceof attack_effects_1.PutDamageEffect) && (0, prefabs_1.HAS_MARKER)(this.COUNTER_PRESS_MARKER, effect.target, this) && state.phase === game_1.GamePhase.ATTACK) {
            effect.source.damage += effect.damage;
        }
        (0, prefabs_1.CLEAR_MARKER_AND_OPPONENTS_POKEMON_MARKER_AT_END_OF_TURN)(state, effect, this.CLEAR_COUNTER_PRESS_MARKER, this.COUNTER_PRESS_MARKER, this);
        return state;
    }
}
