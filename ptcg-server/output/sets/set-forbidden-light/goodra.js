...
class Goodra extends pokemon_card_1.PokemonCard {
    ...
    reduceEffect(store, state, effect) {
        ...
        if (effect instanceof game_effects_1.HealEffect && effect.target.getPokemonCard() === this) {
            (0, prefabs_1.ADD_MARKER)(this.HYDRATION_MARKER, effect.player, this);
        }
        if (effect instanceof play_card_effects_1.PlayPokemonEffect && effect.pokemonCard === this && (0, prefabs_1.HAS_MARKER)(this.HYDRATION_MARKER, effect.player, this)) {
            (0, prefabs_1.REMOVE_MARKER)(this.HYDRATION_MARKER, effect.player, this);
        }
        (0, prefabs_1.REMOVE_MARKER_AT_END_OF_TURN)(effect, this.HYDRATION_MARKER, this);
        // Soaking Horn
        if ((0, prefabs_1.WAS_ATTACK_USED)(effect, 0, this) && (0, prefabs_1.HAS_MARKER)(this.HYDRATION_MARKER, effect.player, this)) {
            effect.damage += 80;
        }
        return state;
    }
