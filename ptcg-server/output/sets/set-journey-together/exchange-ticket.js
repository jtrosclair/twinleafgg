...
exports.RedeemableTicket = void 0;
const game_1 = require("../../game");
const play_card_effects_1 = require("../../game/store/effects/play-card-effects");
class RedeemableTicket extends game_1.TrainerCard {
    constructor() {
        super(...arguments);
        this.trainerType = game_1.TrainerType.ITEM;
        this.regulationMark = 'I';
        this.set = 'JTG';
        this.name = 'Redeemable Ticket';
        this.cardImage = 'assets/cardback.png';
        this.setNumber = '156';
        this.fullName = 'Redeemable Ticket JTG';
...
exports.RedeemableTicket = RedeemableTicket;
