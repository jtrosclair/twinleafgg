...
const ionos_electrode_1 = require("./ionos-electrode");
...
exports.setJourneyTogether = [
    ...
    new spiky_energy_1.SpikyEnergy(),
    ...
    new ionos_tadbulb_1.IonosTadbulb(),
    new ionos_bellibolt_ex_1.IonosBelliboltex(),
    new ionos_wattrel_1.IonosWattrel(),
    new ionos_kilowattrel_1.IonosKilowattrel(),
    new ionos_voltorb_1.IonosVoltorb(),
    new ionos_electrode_1.IonosElectrode(),
    ...
    new other_prints_1.ProfessorsResearchJTG(),
    new other_prints_1.BlackBeltsTrainingJTG(),
];
