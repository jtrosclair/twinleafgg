...
exports.MiracleDiamond = void 0;
const game_1 = require("../../game");
const play_card_effects_1 = require("../../game/store/effects/play-card-effects");
class MiracleDiamond extends game_1.TrainerCard {
    constructor() {
        super(...arguments);
        this.trainerType = game_1.TrainerType.ITEM;
        this.set = 'BRP';
        this.name = 'Miracle Diamond';
        this.cardImage = 'assets/cardback.png';
        this.setNumber = '1';
        this.fullName = 'Miracle Diamond BRP';
        this.text = 'Look at all of your face-down Prize cards. You may choose 1 Trainer, Supporter, or Stadium card you find there, show it to your opponent, and put it into your hand. If you do, put this card as a Prize card face up instead of discarding it.';
    }
    reduceEffect(store, state, effect) {
        if (effect instanceof play_card_effects_1.TrainerEffect && effect.trainerCard === this) {
            ...
            store.prompt(state, new game_1.ChooseCardsPrompt(player, game_1.GameMessage.CHOOSE_CARD_TO_HAND, allPrizeCards, { superType: game_1.SuperType.TRAINER }, { min: 0, max: 1, allowCancel: false, blocked: blocked }), chosenPrize => {
...
exports.MiracleDiamond = MiracleDiamond;
