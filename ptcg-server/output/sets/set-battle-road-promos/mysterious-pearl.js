...
class MysteriousPearl extends game_1.TrainerCard {
    ...
    reduceEffect(store, state, effect) {
        if (effect instanceof play_card_effects_1.TrainerEffect && effect.trainerCard === this) {
            ...
            store.prompt(state, new game_1.ChooseCardsPrompt(player, game_1.GameMessage.CHOOSE_CARD_TO_HAND, allPrizeCards, { superType: game_1.SuperType.POKEMON }, { min: 0, max: 1, allowCancel: false, blocked: blocked }), chosenPrize => {
