...
class BoostShake extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
        this.trainerType = card_types_1.TrainerType.ITEM;
        this.set = 'EVS';
        this.name = 'Boost Shake';
        this.fullName = 'Boost Shake EVS';
        this.cardImage = 'assets/cardback.png';
        this.setNumber = '142';
        this.text = 'Search your deck for a card that evolves from 1 of your Pokémon and put it onto that Pokémon to evolve it. Then, shuffle your deck. You can use this card during your first turn or on a Pokémon that was put into play this turn. Your turn ends.';
    }
