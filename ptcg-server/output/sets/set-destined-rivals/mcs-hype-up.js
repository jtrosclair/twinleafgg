...
class EmceesHype extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
        ...
        this.name = 'Emcee\'s Hype';
        this.fullName = 'Emcee\'s Hype DRI';
