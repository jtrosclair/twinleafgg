...
class WellspringMaskOgerpon extends game_1.PokemonCard {
    constructor() {
        ...
        this.fullName = 'Wellspring Mask Ogerpon DRI';
    }
    reduceEffect(store, state, effect) {
        if ((0, prefabs_1.WAS_ATTACK_USED)(effect, 0, this)) {
            const player = effect.player;
            return (0, prefabs_1.ATTACH_ENERGY_PROMPT)(store, state, player, game_1.PlayerType.BOTTOM_PLAYER, game_1.SlotType.DECK, [game_1.SlotType.ACTIVE, game_1.SlotType.BENCH], { energyType: game_1.EnergyType.BASIC, name: 'Water Energy' }, { min: 0, max: 1, allowCancel: false });
        }
