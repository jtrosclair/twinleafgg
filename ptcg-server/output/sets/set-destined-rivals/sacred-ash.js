...
function* playCard(next, store, state, self, effect) {
    ...
    let cards = [];
    yield store.prompt(state, new choose_cards_prompt_1.ChooseCardsPrompt(player, game_message_1.GameMessage.CHOOSE_CARD_TO_DECK, player.discard, { superType: card_types_1.SuperType.POKEMON }, { min: 1, max, allowCancel: true, blocked }), selected => {
        cards = selected || [];
        next();
    });
...
class SacredAsh extends trainer_card_1.TrainerCard {
    constructor() {
        ...
        this.fullName = 'Sacred Ash DRI';
        this.cardImage = 'assets/cardback.png';
        this.setNumber = '168';
        this.text = 'Shuffle up to 5 Pokémon from your discard pile into your deck.';
    }
