...
class QuickBall extends trainer_card_1.TrainerCard {
    constructor() {
        ...
        this.fullName = 'Quick Ball MD';
        this.cardImage = 'assets/cardback.png';
        this.setNumber = '86';
        this.text = 'Reveal cards from the top of your deck until you reveal a Pokémon. Show that Pokémon to your opponent and put it into your hand. Shuffle the other revealed cards back into your deck. (If you don\'t reveal a Pokémon, shuffle all revealed cards back into your deck.)';
    }
