...
class Fearow extends pokemon_card_1.PokemonCard {
    constructor() {
        ...
        this.retreat = [C];
        this.PREVENT_ALL_DAMAGE_AND_EFFECTS_MARKER = 'FEAROW_PHF_PREVENT_ALL_MARKER';
        this.CLEAR_PREVENT_MARKER = 'FEAROW_PHF_CLEAR_PREVENT_MARKER';
        this.attacks = [
            {
                name: 'Fly',
                cost: [C, C],
