...
class Nessa extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
        ...
        this.name = 'Nessa';
        this.fullName = 'Nessa VIV';
        this.text = 'Put up to 4 in any combination of [W] Pokémon and [W] Energy cards from your discard pile into your hand.';
    }
