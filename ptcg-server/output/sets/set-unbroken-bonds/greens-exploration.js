    ...
    reduceEffect(store, state, effect) {
        if (effect instanceof play_card_effects_1.TrainerEffect && effect.trainerCard === this) {
            ...
            try {
                ...
                if (playerActive && playerActive.powers.some(power => power.powerType === game_1.PowerType.ABILITY)) {
            ...
            if (player.bench.some(b => b.cards.length > 0)) {
                ...
                try {
                    ...
                    pokemonWithAbilities.push(...benchPokemon.filter(card => card.powers.some(power => power.powerType === game_1.PowerType.ABILITY)));
                }
                catch (_b) {
