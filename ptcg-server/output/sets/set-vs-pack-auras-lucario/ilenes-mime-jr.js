...
class IlenesMimeJr extends pokemon_card_1.PokemonCard {
    constructor() {
        super(...arguments);
        this.stage = card_types_1.Stage.BASIC;
        this.tags = [card_types_1.CardTag.VS];
        this.cardType = P;
        this.hp = 50;
        ...
        this.setNumber = '3';
        this.name = 'Ilene\'s Mime Jr.';
        this.fullName = 'Ilene\'s Mime Jr. MAL';
    }
...
exports.IlenesMimeJr = IlenesMimeJr;
