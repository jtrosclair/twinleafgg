...
class Zigzagoon extends pokemon_card_1.PokemonCard {
    constructor() {
        ...
        this.name = 'Zigzagoon';
        this.fullName = 'Zigzagoon PRC';
        this.DEFENDING_POKEMON_CANNOT_ATTACK_MARKER = 'DEFENDING_POKEMON_CANNOT_ATTACK_MARKER_ZIGZAGOON';
        this.SAND_ATTACK_MARKER = 'SAND_ATTACK_MARKER_ZIGZAGOON';
    }
