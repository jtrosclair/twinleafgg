...
class PokemonNurse extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
        this.trainerType = card_types_1.TrainerType.SUPPORTER;
        this.set = 'EX';
        this.name = 'Pokémon Nurse';
        this.fullName = 'Pokémon Nurse EX';
        this.cardImage = 'assets/cardback.png';
        this.setNumber = '145';
        this.text = 'Remove all damage counters from 1 of your Pokémon. Then discard all Energy cards attached to it, if any.';
    }
...
exports.PokemonNurse = PokemonNurse;
