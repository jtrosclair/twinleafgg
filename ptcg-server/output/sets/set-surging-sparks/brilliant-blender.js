...
exports.BrilliantBlender = void 0;
...
function* playCard(next, store, state, effect) {
    ...
    yield store.prompt(state, new choose_cards_prompt_1.ChooseCardsPrompt(player, game_message_1.GameMessage.CHOOSE_CARD_TO_DISCARD, player.deck, {}, { min: 1, max: 5, allowCancel: false }), selected => {
        cards = selected || [];
        next();
    });
...
class BrilliantBlender extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
...
exports.BrilliantBlender = BrilliantBlender;
