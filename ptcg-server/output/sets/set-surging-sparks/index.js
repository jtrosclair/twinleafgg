...
exports.setSurgingSparks = [
    ...
    new gravity_mountain_1.GravityMountain(),
    new cyrano_1.Cyrano(),
    new dedenne_1.Dedenne(),
    new miraculous_intercom_1.MiraculousIntercom(),
    new fuecoco_1.Fuecoco(),
    new gastrodon_1.Gastrodon(),
    new crocalor_1.Crocalor(),
    new skeledirge_1.Skeledirge(),
    new milotic_ex_1.Miloticex(),
    new togepi_1.Togepi(),
    ...
    new hydreigon_ex_1.Hydreigonex(),
    new eternatus_1.Eternatus(),
    new vivillion_1.Vivillion(),
    new azelf_1.Azelf(),
    new uxie_1.Uxie(),
    ...
    new megaton_blower_1.MegatonBlower(),
    new smoochum_1.Smoochum(),
    new celebration_fanfare_1.CelebrationFanfare(),
    new dragons_elixir_1.DragonsElixir(),
    new drayton_1.Drayton(),
    new rich_energy_1.RichEnergy(),
    new klefki_1.Klefki(),
    new exeggcute_1.Exeggcute(),
    new alolan_exeggutor_ex_1.AlolanExeggutorex(),
    new vulpix_1.Vulpix(),
    ...
    new full_art_1.MiloticexFA(),
    new full_art_1.PikachuexFA(),
    new full_art_1.LatiasexFA(),
    new full_art_1.HydreigonexFA(),
    new full_art_1.ArchaludonexFA(),
    new full_art_1.CyranoFA(),
    new full_art_1.LisiasAppealFA(),
    new full_art_1.SurferFA(),
    new full_art_1.MiloticexSIR(),
    new full_art_1.PikachuexSIR(),
    new full_art_1.LatiasexSIR(),
    new full_art_1.HydreigonexSIR(),
    new full_art_1.ArchaludonexSIR(),
    new full_art_1.LisiasAppealSIR(),
    new full_art_1.PikachuexUR(),
    new full_art_1.CounterGainUR(),
    new full_art_1.NightStretcherUR(),
    new full_art_1.JetEnergyUR(),
];
