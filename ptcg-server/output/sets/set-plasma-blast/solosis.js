...
class Solosis extends pokemon_card_1.PokemonCard {
    constructor() {
        ...
        this.name = 'Solosis';
        this.fullName = 'Solosis PLB';
        this.PREVENT_ALL_MARKER = 'PREVENT_ALL_DAMAGE_AND_EFFECTS_SOLOSIS';
        this.CLEAR_PREVENT_ALL_MARKER = 'CLEAR_PREVENT_ALL_DAMAGE_AND_EFFECTS_SOLOSIS';
    }
