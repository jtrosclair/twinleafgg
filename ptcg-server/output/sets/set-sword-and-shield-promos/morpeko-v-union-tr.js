...
exports.MorpekoVUNIONTopRight = void 0;
...
class MorpekoVUNIONTopRight extends pokemon_card_1.PokemonCard {
    constructor() {
        super(...arguments);
    ...
    reduceEffect(store, state, effect) {
        ...
        if ((0, prefabs_1.WAS_POWER_USED)(effect, 0, this)) {
            ...
            if (topLeftPiece && topRightPiece && bottomLeftPiece && bottomRightPiece) {
                if (slots.length > 0) {
                    player.discard.cards.forEach(card => { if (card instanceof MorpekoVUNIONTopRight) {
...
exports.MorpekoVUNIONTopRight = MorpekoVUNIONTopRight;
