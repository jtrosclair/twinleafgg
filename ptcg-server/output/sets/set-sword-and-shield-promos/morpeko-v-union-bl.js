...
exports.MorpekoVUNIONBottomLeft = void 0;
...
class MorpekoVUNIONBottomLeft extends pokemon_card_1.PokemonCard {
    constructor() {
        super(...arguments);
        ...
        if ((0, prefabs_1.WAS_POWER_USED)(effect, 0, this)) {
            ...
            if (topLeftPiece && topRightPiece && bottomLeftPiece && bottomRightPiece) {
                if (slots.length > 0) {
                    ...
                    player.discard.cards.forEach(card => { if (card instanceof MorpekoVUNIONBottomLeft) {
                        player.discard.moveCardTo(card, slots[0]);
                    } });
...
exports.MorpekoVUNIONBottomLeft = MorpekoVUNIONBottomLeft;
