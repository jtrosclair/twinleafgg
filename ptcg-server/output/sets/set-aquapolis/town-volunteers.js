...
class TownVolunteers extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
        ...
        this.setNumber = '136';
        this.name = 'Town Volunteers';
        this.fullName = 'Town Volunteers AQ';
        this.text = 'Take 5 Baby Pokémon, Basic Pokémon, Evolution, and/or basic Energy cards from your discard pile and then show them to your opponent. Shuffle them into your deck.';
    }
...
exports.TownVolunteers = TownVolunteers;
