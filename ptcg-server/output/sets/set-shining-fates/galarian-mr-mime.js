...
class GalarianMrMime extends pokemon_card_1.PokemonCard {
    constructor() {
        ...
        this.set = 'SHF';
        this.setNumber = 'SV020';
        this.cardImage = 'assets/cardback.png';
        this.name = 'Galarian Mr. Mime';
        this.fullName = 'Galarian Mr. Mime SHF';
        this.REDUCE_DAMAGE_MARKER = 'GALARIAN_MR_MIME_SHF_REDUCE_DAMAGE_MARKER';
        this.CLEAR_REDUCE_DAMAGE_MARKER = 'GALARIAN_MR_MIME_SHF_CLEAR_REDUCE_DAMAGE_MARKER';
    }
