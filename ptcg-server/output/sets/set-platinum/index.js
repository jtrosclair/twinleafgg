...
exports.setPlatinum = void 0;
const other_prints_1 = require("./other-prints");
const broken_time_space_1 = require("./broken-time-space");
const bronzong_g_1 = require("./bronzong-g");
...
const skuntank_g_1 = require("./skuntank-g");
...
exports.setPlatinum = [
    new broken_time_space_1.BrokenTimeSpace(),
    new bronzong_g_1.BronzongG(),
    ...
    new other_prints_1.PokeBallPL(),
    new other_prints_1.PokedexHandyPL(),
    new other_prints_1.ElectabuzzPL(),
    new other_prints_1.HitmonchanPL(),
    new other_prints_1.ScytherPL(),
];
