...
function* playCard(next, store, state, effect) {
    ...
    yield store.prompt(state, new choose_cards_prompt_1.ChooseCardsPrompt(player, game_message_1.GameMessage.CHOOSE_CARDS_TO_PUT_ON_BOTTOM_OF_THE_DECK, player.hand, {}, { allowCancel: false, min: 2, max: 2 }), selected => {
        cards = selected || [];
        next();
    });
