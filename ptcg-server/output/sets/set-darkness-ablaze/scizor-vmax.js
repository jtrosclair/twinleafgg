...
class ScizorVmax extends pokemon_card_1.PokemonCard {
    constructor() {
        super(...arguments);
        this.tags = [card_types_1.CardTag.POKEMON_VMAX];
        this.stage = card_types_1.Stage.VMAX;
        this.evolvesFrom = 'Scizor V';
        this.cardType = M;
        this.hp = 320;
        this.weakness = [{ type: R }];
        this.resistance = [{ type: G, value: -30 }];
        this.retreat = [C, C];
        this.REDUCE_DAMAGE_MARKER = 'SCIZOR_VMAX_DAA_REDUCE_DAMAGE_MARKER';
        this.CLEAR_REDUCE_DAMAGE_MARKER = 'SCIZOR_VMAX_DAA_CLEAR_REDUCE_DAMAGE_MARKER';
        this.attacks = [
            {
                name: 'Hard Scissors',
                cost: [M, C],
        ...
        this.name = 'Scizor VMAX';
        this.fullName = 'Scizor VMAX DAA';
    }
