...
const holon_mentor_1 = require("./holon-mentor");
const holon_ruins_1 = require("./holon-ruins");
const holon_scientist_1 = require("./holon-scientist");
const holon_transceiver_1 = require("./holon-transceiver");
const holon_researcher_1 = require("./holon-researcher");
const holons_electrode_1 = require("./holons-electrode");
const holons_magnemite_1 = require("./holons-magnemite");
const holons_magneton_1 = require("./holons-magneton");
...
exports.setEXDeltaSpecies = [
    ...
    new holon_mentor_1.HolonMentor(),
    new holon_ruins_1.HolonRuins(),
    new holon_scientist_1.HolonScientist(),
    new holon_transceiver_1.HolonTransceiver(),
    new holon_researcher_1.HolonResearcher(),
    new holons_electrode_1.HolonsElectrode(),
    new holons_magnemite_1.HolonsMagnemite(),
    new holons_magneton_1.HolonsMagneton(),
