...
class Porygon2 extends pokemon_card_1.PokemonCard {
    ...
    reduceEffect(store, state, effect) {
        (0, prefabs_1.REMOVE_MARKER_AT_END_OF_TURN)(effect, this.BACKUP_MARKER, this);
        if ((0, prefabs_1.WAS_POWER_USED)(effect, 0, this)) {
            const player = effect.player;
            //Once per turn
            if ((0, prefabs_1.HAS_MARKER)(this.BACKUP_MARKER, player, this)) {
                throw new game_1.GameError(game_1.GameMessage.POWER_ALREADY_USED);
            }
            (0, prefabs_1.BLOCK_IF_HAS_SPECIAL_CONDITION)(player, this);
            (0, prefabs_1.DRAW_CARDS_UNTIL_CARDS_IN_HAND)(player, 6);
            (0, prefabs_1.ADD_MARKER)(this.BACKUP_MARKER, player, this);
