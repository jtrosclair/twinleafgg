    ...
    targets.forEach(target => {
        ...
        if (target.tools.length > 0) {
            if (target.tools.length > 1) {
                store.prompt(state, new game_1.ChooseCardsPrompt(player, game_1.GameMessage.CHOOSE_CARD_TO_DISCARD, target, { superType: game_1.SuperType.TRAINER, trainerType: game_1.TrainerType.TOOL }, { min: 1, max: 1, allowCancel: false }), selected => {
