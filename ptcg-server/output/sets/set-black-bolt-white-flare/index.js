...
exports.setSV11 = void 0;
const alomomola_1 = require("./alomomola");
const amoongus_1 = require("./amoongus");
const antique_plume_fossil_1 = require("./antique-plume-fossil");
...
exports.setSV11 = [
    ...
    new serperior_ex_1.Serperiorex(),
    new tepig_1.Tepig(),
    ...
    new drillbur_1.Drillbur(),
    new emolga_1.Emolga(),
    new energy_coin_1.EnergyCoin(),
    new excadrill_ex_1.Excadrillex(),
    new fennel_1.Fennel(),
    ...
    new ignition_energy_1.IgnitionEnergy(),
    new other_prints_1.PrismEnergySV11(),
    new axew_1.Axew(),
    new fraxure_1.Fraxure(),
    new haxorus_1.Haxorus(),
    new cottonee_1.Cottonee(),
    new whimsicott_ex_1.Whimsicottex(),
    new ns_plan_1.NsPlan(),
    new brave_bangle_1.BraveBangle(),
    new frillish_1.Frillish(),
    new jellicent_ex_1.Jellicentex(),
    //SV11B ARs
    new other_prints_1.SnivyAR(),
    new other_prints_1.ServineAR(),
    new other_prints_1.VictiniAR(),
    new other_prints_1.LarvestaAR(),
    new other_prints_1.VolcaronaAR(),
    new other_prints_1.TympoleAR(),
    new other_prints_1.PalpitoadAR(),
    new other_prints_1.SeismitoadAR(),
    new other_prints_1.TirtougaAR(),
    new other_prints_1.CarracostaAR(),
    new other_prints_1.AlomomolaAR(),
    ...
    new other_prints_1.FraxureAR(),
    new other_prints_1.HaxorusAR(),
    //SV11B FA
    new other_prints_1.SerperiorexFA(),
    new other_prints_1.KyuremexFA(),
    new other_prints_1.ZekromexFA(),
    new other_prints_1.MeloettaexFA(),
    new other_prints_1.ExcadrillexFA(),
    new other_prints_1.GenesectexFA(),
    new other_prints_1.NsPlanFA(),
    new other_prints_1.FennelFA(),
    //SV11B SIR
    new other_prints_1.SerperiorexSIR(),
    new other_prints_1.KyuremexSIR(),
    new other_prints_1.ZekromexSIR(),
    new other_prints_1.MeloettaexSIR(),
    new other_prints_1.ExcadrillexSIR(),
    new other_prints_1.GenesectexSIR(),
    new other_prints_1.NsPlanSIR(),
    //SV11B RRB
    new other_prints_1.VictiniRRB(),
    //SV11B BR
    new other_prints_1.ZekromexBR(),
    //SV11W ARs
    new other_prints_1.CottoneeAR(),
    new other_prints_1.VirizionAR(),
    new other_prints_1.TepigAR(),
    new other_prints_1.PigniteAR(),
    new other_prints_1.EmboarAR(),
    new other_prints_1.OshawottAR(),
    new other_prints_1.DewottAR(),
    new other_prints_1.SamurottAR(),
    new other_prints_1.JoltikAR(),
    new other_prints_1.GalvantulaAR(),
    new other_prints_1.FrillishAR(),
    new other_prints_1.ArchenAR(),
    new other_prints_1.ArcheopsAR(),
    new other_prints_1.TerrakionAR(),
    new other_prints_1.ZoruaAR(),
    new other_prints_1.ZoroarkAR(),
    new other_prints_1.DeinoAR(),
    new other_prints_1.ZweilousAR(),
    //SV11W FA
    new other_prints_1.WhimsicottexFA(),
    new other_prints_1.ReshiramexFA(),
    new other_prints_1.KeldeoexFA(),
    new other_prints_1.JellicentexFA(),
    new other_prints_1.HydreigonexFA(),
    new other_prints_1.BouffalantexFA(),
    new other_prints_1.HildaFA(),
    //SV11W SIR
    new other_prints_1.WhimsicottexSIR(),
    new other_prints_1.ReshiramexSIR(),
    new other_prints_1.KeldeoexSIR(),
    new other_prints_1.JellicentexSIR(),
    new other_prints_1.HydreigonexSIR(),
    new other_prints_1.BouffalantexSIR(),
    new other_prints_1.HildaSIR(),
    //SV11W RRW
    new other_prints_1.VictiniRRW(),
    //SV11W WR
    new other_prints_1.ReshiramexWR(),
];
