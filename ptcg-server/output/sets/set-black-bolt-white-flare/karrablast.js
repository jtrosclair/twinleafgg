...
class Karrablast extends pokemon_card_1.PokemonCard {
    ...
    reduceEffect(store, state, effect) {
        ...
        if (effect instanceof play_card_effects_1.PlayPokemonEffect) {
            ...
            if (!player.bench.some(b => { var _a; return ((_a = b.getPokemonCard()) === null || _a === void 0 ? void 0 : _a.name) === 'Shelmet'; }) && ((_a = player.active.getPokemonCard()) === null || _a === void 0 ? void 0 : _a.name) !== 'Shelmet') {
                return state;
            }
