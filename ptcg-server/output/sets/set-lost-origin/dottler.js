...
class Dottler extends pokemon_card_1.PokemonCard {
    constructor() {
        ...
        this.retreat = [C, C];
        this.REDUCE_DAMAGE_MARKER = 'DOTTLER_LOR_REDUCE_DAMAGE_MARKER';
        this.CLEAR_REDUCE_DAMAGE_MARKER = 'DOTTLER_LOR_CLEAR_REDUCE_DAMAGE_MARKER';
        this.attacks = [
            {
                name: 'Barrier Attack',
                cost: [G, C],
        ...
        this.name = 'Dottler';
        this.fullName = 'Dottler LOR 19';
    }
    reduceEffect(store, state, effect) {
        // Attack 1: Barrier Attack
