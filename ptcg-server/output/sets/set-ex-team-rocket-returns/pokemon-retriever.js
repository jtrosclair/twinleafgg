...
exports.PokemonRetriever = void 0;
...
class PokemonRetriever extends trainer_card_1.TrainerCard {
    constructor() {
        super(...arguments);
        ...
        this.setNumber = '84';
        this.name = 'Pokémon Retriever';
        this.fullName = 'Pokémon Retriever TRR';
        this.text = 'Search your discard pile for Basic Pokémon and Evolution cards. You may either show 1 Basic Pokémon or Evolution card to your opponent and put it into your hand, or show a combination of 3 Basic Pokémon or Evolution cards to your opponent and shuffle them into your deck.';
    }
...
exports.PokemonRetriever = PokemonRetriever;
